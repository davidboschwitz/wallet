...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppWalletWalletComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _wallet_wallet_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./wallet/wallet.component */
    "./src/app/wallet/wallet.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_service_worker__WEBPACK_IMPORTED_MODULE_5__["ServiceWorkerModule"].register("ngsw-worker.js", {
  ...
  function srcAppDbServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var promiseGenerator = function promiseGenerator() {
      var resolve, reject;
    ...
    var DBService = DBService_1 =
    /*#__PURE__*/
    function () {
      function DBService() {// this.initDB(); 
      ...
      _createClass(DBService, [{
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 3;
                    return DBService_1.initDB();

                  case 3:
                    p = promiseGenerator();
                    request = DBService_1.db.transaction(table, 'readwrite').objectStore(table).add(obj);
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    p = promiseGenerator();
                    request = DBService_1.db.transaction(table).objectStore(table).get(key);
                    ...
                    return _context2.abrupt("return", p.promise);
        ...
        value: function getAll(table) {
          ...
          regeneratorRuntime.mark(function _callee3() {
            var p, transaction, objectStore, request, items;
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 3:
                    p = promiseGenerator();
                    transaction = DBService_1.db.transaction(table, 'readonly');
                    ...
                    return _context3.abrupt("return", p.promise);
        ...
        key: "deleteItem",
        value: function deleteItem(table, key) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 3:
                    p = promiseGenerator();
                    request = DBService_1.db.transaction(table, 'readwrite').objectStore(table).delete(key);
                    ...
                    return _context4.abrupt("return", p.promise);
                  ...
                  case 5:
                    ...
                    request.onupgradeneeded = function (event) {
                      ...
                      if (event.oldVersion < 1) {
                        var tabs = db.createObjectStore("cards", {
                          keyPath: "id"
                        });
                        tabs.createIndex("name", "name", {
                          unique: false
                        });
                    ...
                    return _context5.abrupt("return", p.promise);
    ...
    DBService = DBService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], DBService);
    /***/
  },
  ...
  /***/
  function srcAppWalletWalletComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppWalletWalletComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _db_service_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../db-service.service */
    "./src/app/db-service.service.ts");
    ...
    /*#__PURE__*/
    function () {
      function WalletComponent(db) {
        _classCallCheck(this, WalletComponent);

        this.db = db;
        this.renderDelay = 200;
        this.formats = ["CODE128", "UPC", "EAN13", "EAN8", "EAN5", "EAN2", "CODE39", "ITF14", "MSI", "pharmacode", "codabar"];
        this.cards = [];
        this.newCard = {
      ...
      _createClass(WalletComponent, [{
                ...
                switch (_context6.prev = _context6.next) {
                  ...
                  case 2:
                    ...
                    setTimeout(function () {
                      ...
                      try {
                        for (var _iterator = _this.cards[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        key: "mouseDown",
        value: function mouseDown(card) {
          this.timeDown = Date.now();
        }
      }, {
        key: "mouseUp",
        value: function mouseUp(card) {
          if (Date.now() - this.timeDown > 1000) {
            if (confirm("Delete this card?\n".concat(card.name, " (").concat(card.id, ")"))) {
    ...
    WalletComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-wallet",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./wallet.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/wallet/wallet.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./wallet.component.css */
      "./src/app/wallet/wallet.component.css")).default]
    })], WalletComponent);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /mnt/c/Users/dbosch/workspace/wallet/wallet-app/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
